...
export const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { key: 'topology', label: '空间拓扑', path: '/topology', icon: Map, group: 'operations' },
    ...
    items: [
      {
        ...
        group: 'visual',
        children: [
          { key: 'visual-storage', label: '储能电站', path: '/visual/storage-station', icon: BatteryCharging, group: 'visual' },
          { key: 'visual-production-line', label: '产线展示', path: '/visual/production-line', icon: Factory, group: 'visual' },
          { key: 'visual-industrial-screen', label: '工业大屏', path: '/visual/industrial-screen', icon: MonitorPlay, group: 'visual' },
          { key: 'visual-instruments', label: '仪表监控', path: '/visual/instruments', icon: Gauge, group: 'visual' },
          { key: 'visual-data-center', label: '数据中心仿真', path: '/visual/data-center', icon: Server, group: 'visual' },
          { key: 'visual-power', label: '输配电', path: '/visual/power-distribution', icon: Zap, group: 'visual' },
          { key: 'visual-port', label: '港口运输', path: '/visual/port', icon: Anchor, group: 'visual' },
        ],
      },
    ],
  },
